...
export default class CreateRoomPage extends Component  {
    ...
    constructor(props) {
        ...
        this.handleRoomButtonSelect = this.handleRoomButtonSelect.bind(this);
    }
    ...
    render() {
        return <Grid container spacing={1}> 
            ...
            <Grid item xs={12} align="center">
                <Button color="primary" variant="contained" onClick={this.handleRoomButtonSelect}>Create a Room</Button>
            </Grid>
            <Grid item xs={12} align="center">
